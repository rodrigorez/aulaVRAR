/**
 * 🌌 SHADER SHADERS - Convertido do Shadertoy
...
const shaderSFragmentShader = `uniform float time;
...
// 🚀 Registra o shader
registrarShader('shaderS-shader', null, shaderSFragmentShader);

// 📝 Para aplicar este shader ao mundo, use:
// aplicarShaderAoSky('shaderS-shader', NUMERO_DO_MUNDO);
