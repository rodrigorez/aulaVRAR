/**
 * 🌌 SHADER SHADERA - Convertido do Shadertoy
...
const shaderAFragmentShader = `uniform float time;
...
vec4 effect(vec2 screenSize, vec2 screen_coords) {
    ...
    if(IS_ROTATE){
       speed = (time * timeMultiplier) * speed;
    }
    speed += 302.2;
    ...
    uv *= 30.;
    speed = (time * timeMultiplier)*(SPIN_SPEED);
...
// 🚀 Registra o shader
registrarShader('shaderA-shader', null, shaderAFragmentShader);

// 📝 Para aplicar este shader ao mundo, use:
// aplicarShaderAoSky('shaderA-shader', NUMERO_DO_MUNDO);
